...
- (NSString *)getFollowedTimelineSinceID:(NSString *)sinceID withMaximumID:(int)maxID startingAtPage:(int)pageNum count:(int)count; // statuses/friends_timeline
...
- (NSString *)getBulkUserInformationFor:(NSString *)userIDs; // users/lookup
...
- (NSString *)getFriendIDsFor:(NSString *)username; // friends/ids
