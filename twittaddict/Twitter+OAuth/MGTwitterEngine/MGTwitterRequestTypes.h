...
typedef enum _MGTwitterRequestType {
	...
	MGTwitterBulkUserInformationRequest, // bulk user information for up to 100 ids
	MGTwitterFriendIDsRequest, // get array of friend ids for current user
...
#endif
	MGTwitterSocialGraph		= 10,   // an array of user ids
