...
- (NSString *)getHomeTimelineSinceID:(NSString *)sinceID startingAtPage:(int)page count:(int)count; // statuses/home_timeline
{
  return [self getHomeTimelineSinceID:sinceID withMaximumID:0 startingAtPage:page count:count];
}

- (NSString *)getHomeTimelineSinceID:(NSString *)sinceID withMaximumID:(MGTwitterEngineID)maxID startingAtPage:(int)page count:(int)count; // statuses/home_timeline
{
